...
instance Print Syntax.Normal.Abs.Program where
  prt i = \case
    Syntax.Normal.Abs.ProgramExprs expr -> prPrec i 0 (concatD [prt 0 expr])

instance Print Syntax.Normal.Abs.Expr where
  prt i = \case
    Syntax.Normal.Abs.Seq exprs -> prPrec i 0 (concatD [prt 0 exprs])
    ...
    Syntax.Normal.Abs.Assign expr1 expr2 -> prPrec i 0 (concatD [prt 1 expr1, doc (showString ":="), prt 0 expr2])
    Syntax.Normal.Abs.Application expr1 expr2 -> prPrec i 1 (concatD [prt 1 expr1, prt 2 expr2])
    Syntax.Normal.Abs.NewRef expr -> prPrec i 2 (concatD [doc (showString "ref"), prt 3 expr])
    Syntax.Normal.Abs.DeRef expr -> prPrec i 2 (concatD [doc (showString "!"), prt 3 expr])
    ...
    Syntax.Normal.Abs.ConstUnit -> prPrec i 3 (concatD [doc (showString "unit")])
    ...
    Syntax.Normal.Abs.Location n -> prPrec i 3 (concatD [doc (showString "#"), prt 0 n])
  prtList _ [] = concatD []
...
instance Print Syntax.Normal.Abs.Store where
  prt i = \case
    Syntax.Normal.Abs.Store assignments -> prPrec i 0 (concatD [doc (showString "{"), prt 0 assignments, doc (showString "}")])

instance Print Syntax.Normal.Abs.Assignment where
  prt i = \case
    Syntax.Normal.Abs.Assignment n expr -> prPrec i 0 (concatD [doc (showString "#"), prt 0 n, doc (showString "="), prt 0 expr])
  prtList _ [] = concatD []
  prtList _ [x] = concatD [prt 0 x]
  prtList _ (x:xs) = concatD [prt 0 x, doc (showString ";"), prt 0 xs]
...
instance Print Syntax.Normal.Abs.StoreTyping where
  prt i = \case
    Syntax.Normal.Abs.StoreTyping locationtypings -> prPrec i 0 (concatD [doc (showString "{"), prt 0 locationtypings, doc (showString "}")])

instance Print Syntax.Normal.Abs.LocationTyping where
  prt i = \case
    Syntax.Normal.Abs.LocationTyping n type_ -> prPrec i 0 (concatD [doc (showString "#"), prt 0 n, doc (showString ":"), prt 0 type_])
  prtList _ [] = concatD []
  prtList _ [x] = concatD [prt 0 x]
  prtList _ (x:xs) = concatD [prt 0 x, doc (showString ";"), prt 0 xs]
...
instance Print Syntax.Normal.Abs.Type where
  prt i = \case
    ...
    Syntax.Normal.Abs.RefType type_ -> prPrec i 1 (concatD [doc (showString "Ref"), prt 2 type_])
    ...
    Syntax.Normal.Abs.UnitType -> prPrec i 2 (concatD [doc (showString "Unit")])
