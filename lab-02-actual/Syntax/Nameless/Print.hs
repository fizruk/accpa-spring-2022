...
instance Print Syntax.Nameless.Abs.Type where
  prt i = \case
    Syntax.Nameless.Abs.BoolType -> prPrec i 0 (concatD [doc (showString "Bool")])
    Syntax.Nameless.Abs.NatType -> prPrec i 0 (concatD [doc (showString "Nat")])
    Syntax.Nameless.Abs.FunType type_1 type_2 -> prPrec i 0 (concatD [prt 0 type_1, doc (showString "->"), prt 0 type_2])
