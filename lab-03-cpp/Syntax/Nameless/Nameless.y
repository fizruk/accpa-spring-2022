...
;
Expr : _KW_if Expr _KW_then Expr _KW_else Expr { $$ = new Nameless::If($2, $4, $6); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
  | _KW_let Expr _KW_in Expr { $$ = new Nameless::Let($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
  ...
  | _LBRACE ListBindingExpr _RBRACE { std::reverse($2->begin(),$2->end()) ;$$ = new Nameless::Record($2); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
  | Expr1 { $$ = $1; $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
;
BindingExpr : _IDENT_ _EQ Expr { $$ = new Nameless::Binding($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bindingexpr_ = $$; }
;
ListBindingExpr : /* empty */ { $$ = new Nameless::ListBindingExpr(); result->listbindingexpr_ = $$; }
  | BindingExpr { $$ = new Nameless::ListBindingExpr(); $$->push_back($1); result->listbindingexpr_ = $$; }
  | BindingExpr _COMMA ListBindingExpr { $3->push_back($1); $$ = $3; result->listbindingexpr_ = $$; }
;
Expr1 : Expr1 Expr2 { $$ = new Nameless::Application($1, $2); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
  | Expr2 { $$ = $1; $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
;
Expr2 : _KW_succ Expr3 { $$ = new Nameless::Succ($2); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
  | Expr3 _DOT _IDENT_ { $$ = new Nameless::Dot($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
  | _KW_pred Expr3 { $$ = new Nameless::Pred($2); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
  | _KW_iszero Expr3 { $$ = new Nameless::IsZero($2); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
  | Expr3 { $$ = $1; $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
;
Expr3 : _KW_true { $$ = new Nameless::ConstTrue(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
  | _KW_false { $$ = new Nameless::ConstFalse(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
  | _SYMB_8 { $$ = new Nameless::ConstZero(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
...
Type : Type1 _RARROW Type { $$ = new Nameless::FunType($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->type_ = $$; }
  | _LBRACE ListFieldTypeExpr _RBRACE { std::reverse($2->begin(),$2->end()) ;$$ = new Nameless::RecordType($2); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->type_ = $$; }
...
;
FieldTypeExpr : _IDENT_ _COLON Type { $$ = new Nameless::FieldType($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->fieldtypeexpr_ = $$; }
;
ListFieldTypeExpr : /* empty */ { $$ = new Nameless::ListFieldTypeExpr(); result->listfieldtypeexpr_ = $$; }
  | FieldTypeExpr { $$ = new Nameless::ListFieldTypeExpr(); $$->push_back($1); result->listfieldtypeexpr_ = $$; }
