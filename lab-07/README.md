...
In this lab, we discuss implementation of an interpreter for simply typed expressions with subtyping of records, variants, lists, and functions.
...
- `Bot` — the subtype of all types (empty type).
