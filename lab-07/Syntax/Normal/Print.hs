...
instance Print Syntax.Normal.Abs.Expr where
  prt i = \case
    ...
    Syntax.Normal.Abs.Variant id_ expr -> prPrec i 0 (concatD [doc (showString "<"), prt 0 id_, doc (showString "="), prt 0 expr, doc (showString ">")])
    ...
    Syntax.Normal.Abs.List exprs -> prPrec i 0 (concatD [doc (showString "["), prt 0 exprs, doc (showString "]")])
...
instance Print Syntax.Normal.Abs.Type where
  prt i = \case
    ...
    Syntax.Normal.Abs.RecordType fieldtypes -> prPrec i 0 (concatD [doc (showString "{"), prt 0 fieldtypes, doc (showString "}")])
    Syntax.Normal.Abs.VariantType fieldtypes -> prPrec i 0 (concatD [doc (showString "<"), prt 0 fieldtypes, doc (showString ">")])
    Syntax.Normal.Abs.ListType type_ -> prPrec i 0 (concatD [doc (showString "["), prt 0 type_, doc (showString "]")])
    ...
    Syntax.Normal.Abs.TopType -> prPrec i 1 (concatD [doc (showString "Top")])
    Syntax.Normal.Abs.BotType -> prPrec i 1 (concatD [doc (showString "Bot")])
