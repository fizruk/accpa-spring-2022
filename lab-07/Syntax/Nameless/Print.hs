...
instance Print Syntax.Nameless.Abs.Expr where
  prt i = \case
    ...
    Syntax.Nameless.Abs.Variant id_ expr -> prPrec i 0 (concatD [doc (showString "<"), prt 0 id_, doc (showString "="), prt 0 expr, doc (showString ">")])
    ...
    Syntax.Nameless.Abs.List exprs -> prPrec i 0 (concatD [doc (showString "["), prt 0 exprs, doc (showString "]")])
...
instance Print Syntax.Nameless.Abs.Type where
  prt i = \case
    ...
    Syntax.Nameless.Abs.RecordType fieldtypes -> prPrec i 0 (concatD [doc (showString "{"), prt 0 fieldtypes, doc (showString "}")])
    Syntax.Nameless.Abs.VariantType fieldtypes -> prPrec i 0 (concatD [doc (showString "<"), prt 0 fieldtypes, doc (showString ">")])
    Syntax.Nameless.Abs.ListType type_ -> prPrec i 0 (concatD [doc (showString "["), prt 0 type_, doc (showString "]")])
    Syntax.Nameless.Abs.BoolType -> prPrec i 1 (concatD [doc (showString "Bool")])
    Syntax.Nameless.Abs.NatType -> prPrec i 1 (concatD [doc (showString "Nat")])
    Syntax.Nameless.Abs.TopType -> prPrec i 1 (concatD [doc (showString "Top")])
    Syntax.Nameless.Abs.BotType -> prPrec i 1 (concatD [doc (showString "Bot")])
