...
module TypeCheck.Nameless where
...
typeOf context expr =
  case expr of
    ...
    Abstraction typeOfArg body -> do
      typeOfBody <- typeOf (typeOfArg : context) body
