...
;
Expr3 : _KW_true { $$ = new Normal::ConstTrue(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
  | _KW_false { $$ = new Normal::ConstFalse(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
  | _SYMB_6 { $$ = new Normal::ConstZero(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->expr_ = $$; }
