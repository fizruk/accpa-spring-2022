...
transExpr x = case x of
  ...
  Syntax.Normal.Abs.Variant ident expr fieldtypes -> failure x
  Syntax.Normal.Abs.Match expr matchcases -> failure x
  Syntax.Normal.Abs.List exprs type_ -> failure x
  ...
  Syntax.Normal.Abs.Fold type_ expr -> failure x
  Syntax.Normal.Abs.Unfold type_ expr -> failure x
...
transType x = case x of
  ...
  Syntax.Normal.Abs.RecType ident type_ -> failure x
  ...
  Syntax.Normal.Abs.VarType ident -> failure x
