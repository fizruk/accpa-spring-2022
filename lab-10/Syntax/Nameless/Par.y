...
Expr : 'if' Expr 'then' Expr 'else' Expr { Syntax.Nameless.Abs.If $2 $4 $6 }
     ...
     | '<' Ident '=' Expr '>' 'as' '<' ListFieldType '>' { Syntax.Nameless.Abs.Variant $2 $4 $8 }
     | 'match' Expr1 '{' ListMatchCase '}' { Syntax.Nameless.Abs.Match $2 $4 }
     | '[' ListExpr ']' 'as' '[' Type ']' { Syntax.Nameless.Abs.List $2 $6 }
     | Expr1 { $1 }

MatchCase :: { Syntax.Nameless.Abs.MatchCase }
MatchCase : '<' Ident '>' '=>' Expr { Syntax.Nameless.Abs.MatchCase $2 $5 }

ListMatchCase :: { [Syntax.Nameless.Abs.MatchCase] }
ListMatchCase : {- empty -} { [] }
              | MatchCase { (:[]) $1 }
...
Expr2 : 'cons' Expr3 Expr3 { Syntax.Nameless.Abs.ConsList $2 $3 }
      | 'head' Expr3 { Syntax.Nameless.Abs.Head $2 }
      | 'tail' Expr3 { Syntax.Nameless.Abs.Tail $2 }
      | 'succ' Expr3 { Syntax.Nameless.Abs.Succ $2 }
      | 'pred' Expr3 { Syntax.Nameless.Abs.Pred $2 }
      | 'iszero' Expr3 { Syntax.Nameless.Abs.IsZero $2 }
      | 'fix' Expr3 { Syntax.Nameless.Abs.Fix $2 }
      | 'isempty' Expr3 { Syntax.Nameless.Abs.IsEmpty $2 }
      | 'fold' '[' Type ']' Expr3 { Syntax.Nameless.Abs.Fold $3 $5 }
      | 'unfold' '[' Type ']' Expr3 { Syntax.Nameless.Abs.Unfold $3 $5 }
      | Expr3 { $1 }

Expr3 :: { Syntax.Nameless.Abs.Expr }
Expr3 : Expr3 '.' Ident { Syntax.Nameless.Abs.Dot $1 $3 }
...
Type : Type1 '->' Type { Syntax.Nameless.Abs.FunType $1 $3 }
     | 'µ' '(' Type ')' { Syntax.Nameless.Abs.RecType $3 }
     | Type1 { $1 }

Type1 :: { Syntax.Nameless.Abs.Type }
Type1 : '{' ListFieldType '}' { Syntax.Nameless.Abs.RecordType $2 }
      | '<' ListFieldType '>' { Syntax.Nameless.Abs.VariantType $2 }
      | '[' Type ']' { Syntax.Nameless.Abs.ListType $2 }
      | Type2 { $1 }

Type2 :: { Syntax.Nameless.Abs.Type }
Type2 : 'Bool' { Syntax.Nameless.Abs.BoolType }
      | 'Nat' { Syntax.Nameless.Abs.NatType }
      | Ident { Syntax.Nameless.Abs.FreeTypeVar $1 }
      | Integer { Syntax.Nameless.Abs.BoundTypeVar $1 }
      | '(' Type ')' { $2 }
