...
transExpr x = case x of
  ...
  Syntax.Nameless.Abs.Variant ident expr fieldtypes -> failure x
  Syntax.Nameless.Abs.Match expr matchcases -> failure x
  Syntax.Nameless.Abs.List exprs type_ -> failure x
  ...
  Syntax.Nameless.Abs.Fold type_ expr -> failure x
  Syntax.Nameless.Abs.Unfold type_ expr -> failure x
...
transType x = case x of
  ...
  Syntax.Nameless.Abs.RecType type_ -> failure x
  ...
  Syntax.Nameless.Abs.FreeTypeVar ident -> failure x
  Syntax.Nameless.Abs.BoundTypeVar integer -> failure x
