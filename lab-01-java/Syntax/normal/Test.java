...
public class Test
{
  ...
  public Test(String[] args)
  {
    try
    {
      ...
      l = new normalLexer(new ANTLRInputStream(input));
    ...
    p = new normalParser(new CommonTokenStream(l));
  ...
  public Syntax.normal.Absyn.Program parse() throws Exception
  {
    ...
    /* Other options are: */
    /* listExpr, expr */
    normalParser.Start_ProgramContext pc = p.start_Program();
    Syntax.normal.Absyn.Program ast = pc.result;
    System.out.println();
